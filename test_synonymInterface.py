...
class TestSynonymInterface(TestCase):
    ...
    def test_find_synonyms(self):
        self.assertEquals(self.test_interface.find_synonyms("yellow"), [u"orange", u"red"])
        self.assertEquals(self.test_interface.find_synonyms("red"), [u"orange", u"yellow", u"crimson"])

    def test_unknown_finder(self):
        crimson_dict = self.test_interface.deal_with_synonym_outside_of_graph(u"red", u"crimson")
        self.assertEqual(crimson_dict["crimson"], [u"red", u"orange"])
